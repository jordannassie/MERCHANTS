       ...
       <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
         ...
         <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
           {[
             ...
             { src: 'https://phhczohqidgrvcmszets.supabase.co/storage/v1/object/public/MERCHANT/images/brands/Carl\'s_Jr._old_stacked.svg', alt: "Carl's Jr." },
           ].map(({ src, alt }) => (
             <div key={alt} className="flex items-center justify-center h-12">
               <Image
                 src={src}
                 alt={alt}
                 width={80}
      ...
      <div className="md:hidden fixed bottom-0 inset-x-0 z-50">
        <div className="bg-white border-t border-slate-200 shadow-lg safe-area-bottom px-4 py-3">
          <div className="flex gap-3">
            <a href="tel:+19497361560" className="flex-1 inline-flex items-center justify-center gap-2 h-12 rounded-lg border border-blue-600 bg-white text-blue-600 font-semibold">
            ...
            <a href={"sms:+19497361560?body=Hi%20Process.Direct%2C%20I%27m%20interested%20in%20card%20processing%2FPOS%20for%20my%20business."} className="flex-1 inline-flex items-center justify-center gap-2 h-12 rounded-lg bg-blue-600 text-white font-semibold">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-5 w-5">
              ...
              {submitted ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    ...
                    <a href="tel:+19497361560" className="text-blue-600 font-semibold">(949) 736-1560</a>.
                  </p>
                  <button
